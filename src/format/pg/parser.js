...
function peg$parse(input, options) {
  ...
  var peg$e13 = peg$otherExpectation("label");
  ...
  var peg$f3 = function(from, direction) {
      return { from, direction }
    };
  var peg$f4 = function(id, from, direction) { return { from, direction } };
  var peg$f5 = function(id, start, to, labels, props) {
  ...
  function peg$parseIgnorableSpace() {
    var s0, s1, s2;
  ...
  function peg$parseUnquotedIdFollowedByDirection() {
  ...
  function peg$parseEdge() {
    ...
    s2 = peg$parseUnquotedIdFollowedByDirection();
    if (s2 === peg$FAILED) {
      s2 = peg$currPos;
  ...
  function peg$parseUnquotedIdentifier() {
    ...
    s0 = peg$currPos;
    s1 = peg$parsePlainStart();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$parsePlainChar();
      while (s3 !== peg$FAILED) {
        s2.push(s3);
        s3 = peg$parsePlainChar();
      }
