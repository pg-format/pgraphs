...
function peg$parse(input, options) {
  ...
  var peg$f5 = function() { return text().slice(0,-1) };
  ...
  var peg$f13 = function() { backticks = text().length };
  var peg$f14 = function() { return backticks-1 };
  var peg$f15 = function() { return backticks };
